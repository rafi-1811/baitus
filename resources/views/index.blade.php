        ...
        <div class="slider">
            <div class="slides">
              ...
              <div class="slide first">
                <img src="{{ Storage::url($bannerhome->imagebanner1) }}" alt="" />              </div>
              <div class="slide">
                <img src="{{ Storage::url($bannerhome->imagebanner2) }}" alt="" />              </div>
              <div class="slide">
                <img src="{{ Storage::url($bannerhome->imagebanner3) }}" alt="" />              </div>
              <div class="slide">
                <img src="{{ Storage::url($bannerhome->imagebanner4) }}" alt="" />              </div>
              <!--slide images end-->
