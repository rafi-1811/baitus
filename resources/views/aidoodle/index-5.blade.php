                            ...
                            <div class="h5_header-top-account">
                                <a href="#">
                                    <svg width="14" height="16" viewBox="0 0 14 16" fill="none"
                                        ...
                                        <path d="M13.026 15C13.026 12.291 10.331 10.1 7.013 10.1C3.695 10.1 1 12.291 1 15"
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                    My Account
                        ...
                        <div class="h5_header-action-wrap d-flex align-items-center justify-content-end">
                            <div class="h5_header-action d-none d-sm-flex">
                                <div class="h5_header-action-inner">
                                    <a class="h5_header-action-search" href="javascript:void(0)" data-bs-toggle="modal"
                                        data-bs-target="#search-modal"><i class="fa-light fa-search"></i></a>
                                    <a href="{{ url('cart') }}" class="h5_header-action-cart"><i
                    ...
                    <div class="col-xl-9">
                        <div class="h5_banner-single">
                            <div class="h5_banner-content">
                                <h1 class="h5_banner-content-title tp_has_fade_anim">Unleash Your Creativity with Stunning
                                    Visuals</h1>
                                <p class="tp_desc_anim">Quisque tempus scelerisque risus faucibus varius. In id vulputate
                                    sem. Integer porttitor est <br> rhoncus congue nibh et accumsan lobortis.</p>
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6 tp_fade_bottom">
                                        <div class="h5_shop-item mb-30">
                                            ...
                                            <div class="h5_shop-content">
                                                <h5 class="h5_shop-content-title"><a href="#">CreatBot Mindful
                                                        Arts</a></h5>
                                                <div class="h5_shop-content-bottom">
                                                    <a href="#"
                                                        class="h5_shop-content-price h5_shop-content-bottom-link">$12.05</a>
                                                    <a href="#" class="h5_shop-content-cart"><i
                                                            class="fa-light fa-shopping-cart"></i> Add To Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item mb-30">
                                        <h2 class="accordion-header" id="headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="collapseOne">What is Doodle Content Writing Tool?
                                            </button>
                                        </h2>
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Sed Mattis eros lectors, eu fermentum Felis laborites convallis. Nam
                                                    Felis arco, sed mi Faubus quips. Fusco id dui nil. Sed ac lorem a dolor
                                                    incident suscept quips Purus. Poetesque auctor fugit Elementa. ante
                                                    ipsum primes in Faubus orca lotus et utricles poseurs cub ilia curare.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item mb-30">
                                        <h2 class="accordion-header" id="headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseTwo">How is the data security
                                                of our chatbots ensured?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item mb-30">
                                        <h2 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseThree">How does the learning
                                                process of AI chatbots work?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item mb-30">
                                        <h2 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseFour">What are the benefits
                                                of AI Chatbots to my business?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item mb-30">
                                        <h2 class="accordion-header" id="headingFive">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseFive">How are AI writers
                                                impacting the writing industry?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="accordion-item mb-30">
                                        <h2 class="accordion-header" id="headingSix">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseSix">How do our hatbots
                ...
                <div class="h5_instagram-wrap">
                    <div class="h5_instagram-item tp_fade_bottom " data-fade-from="bottom">
                        ...
                        <div class="h5_instagram-item-content">
                            <a href="#"><svg width="106" height="106" viewBox="0 0 106 106" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M78 3H28C14.1929 3 3 14.1929 3 28V78C3 91.8071 14.1929 103 28 103H78C91.8071 103 103 91.8071 103 78V28C103 14.1929 91.8071 3 78 3Z"
                                        stroke="currentColor" stroke-width="5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                                        d="M73.0005 49.8515C73.6175 54.0127 72.9068 58.2626 70.9693 61.9966C69.0318 65.7306 65.9662 68.7586 62.2086 70.6499C58.451 72.5412 54.1927 73.1995 50.0394 72.5312C45.8861 71.8628 42.0493 69.9019 39.0747 66.9273C36.1001 63.9527 34.1391 60.1159 33.4708 55.9626C32.8025 51.8093 33.4608 47.551 35.3521 43.7934C37.2434 40.0358 40.2714 36.9702 44.0054 35.0327C47.7394 33.0952 51.9893 32.3844 56.1505 33.0015C60.3951 33.6309 64.3247 35.6088 67.359 38.643C70.3932 41.6773 72.3711 45.6069 73.0005 49.8515Z"
                                        stroke="currentColor" stroke-width="5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M80.5 25.5H80.55" stroke="currentColor" stroke-width="5"
                    ...
                    <div class="h5_instagram-item tp_fade_bottom" data-fade-from="bottom" data-delay="1.1">
                        ...
                        <div class="h5_instagram-item-content">
                            <a href="#"><svg width="106" height="106" viewBox="0 0 106 106"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M78 3H28C14.1929 3 3 14.1929 3 28V78C3 91.8071 14.1929 103 28 103H78C91.8071 103 103 91.8071 103 78V28C103 14.1929 91.8071 3 78 3Z"
                                        stroke="currentColor" stroke-width="5" stroke-linecap="round"
        ...
        <div class="h5_footer-top pt-120 pb-80">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 tp_has_fade_anim" data-fade-from="left"
                        data-delay=".8">
